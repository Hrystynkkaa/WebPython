class User:
    def __init__(self, id, name, role):
        self.id = id
        self.name = name
        self.role = role  # Роль користувача (наприклад, 'admin' чи 'user')

class Policy:
    def __init__(self, id, user_id, coverage):
        self.id = id
        self.user_id = user_id      # ID користувача, до якого належить поліс
        self.coverage = coverage    # Страхове покриття
